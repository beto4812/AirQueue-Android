...
import com.beto4812.airqueue.utils.ThreadUtils;
 ...
 */
public class AWSIdentityManager {

    /**
     * Log tag.
     */
    private static final String LOG_TAG = AWSIdentityManager.class.getSimpleName();
    /**
     ...
     */
    public AWSIdentityManager(final Context appContext, final ClientConfiguration clientConfiguration) {
        Log.d(LOG_TAG, "AWSIdentityManager init");
